...
# Serializers imports
from apps.waallet.api.serializer import (
    WalletSerializer,
...
# Models imports
from apps.waallet.models import Wallet
...
def wallet_api_view(request):
    ...
    # Create
        ...
        transactions = Transaction.objects.filter(credit_account=request.data['account']).first()  # noqa: E501
